...
1. **Clonar el Repositorio**: Descarga o clona la carpeta del proyecto.

2. **Abrir index.html**: Simplemente abre el archivo `index.html` en tu navegador web (Chrome, Firefox, etc.).

3. **Jugar**: El juego te pedirá inmediatamente realizar una apuesta en el modal pop-up para comenzar la partida.

## 🎮 Cómo Jugar

- Realiza tu apuesta inicial cuando aparezca el modal
- Recibe tus dos cartas iniciales
- Decide si quieres **Pedir** (Hit) más cartas o **Plantarte** (Stand)
- Intenta acercarte lo más posible a 21 sin pasarte
- ¡Gana al crupier y duplica tu apuesta!
